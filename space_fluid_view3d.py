...
class OPS_snapping_options(bpy.types.Operator):
    bl_idname = "fd_general.snapping_options"
...
class INFO_MT_fluidaddobject(Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("room_builder.draw_wall",icon='SNAP_PEEL_OBJECT')
        layout.operator("room_builder.draw_mesh", icon='MESH_GRID')
#         layout.separator()
...
class MENU_cursor_tools(Menu):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator_context = 'INVOKE_REGION_WIN'
        layout.operator('fd_general.set_cursor_location',text="Set Cursor Location")
        layout.separator()
